  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex items-center p-4 border-b border-gray-700 bg-white/10 backdrop-blur-xl">
        ...
        <img
          src={data.user.photoURL || 'https://placehold.co/40x40/B3E5FC/039BE5?text=AV'}
          alt="Avatar"
      ...
      {/* Input Section */}
      <form onSubmit={handleSend} className="flex flex-col p-4 border-t border-gray-700 bg-white/10 backdrop-blur-xl">
        ...
        <div className="flex items-center space-x-3">
          ...
          <input
            ...
            className="flex-1 px-5 py-3 text-gray-100 placeholder-gray-400 border border-gray-700 rounded-full bg-white/10 focus:ring-2 focus:ring-blue-500 focus:outline-none"
