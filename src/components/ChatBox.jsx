...
return (
  ...
  {/* Header: Added flex-shrink-0 to ensure it keeps its size and doesn't scroll away */}
  ...
  {/* Messages: flex-1 ensures it takes all remaining vertical space. Removed unnecessary padding-bottom (pb-28) */}
  ...
  {/* bottom-[70px] is an estimate to position it above the input field height (~60px + padding) */}
  {showPicker && (
  ...
  {/* Input: Added flex-shrink-0 to ensure it keeps its size at the bottom */}
  ...
  <div className="flex items-center space-x-3">
    ...
    onFocus={() => setTimeout(() => scrollToBottom('smooth'), 160)} 
